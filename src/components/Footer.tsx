const Footer = () => {
  return (
    <footer className=" bg-neutral-800 text-neutral-100">
      <div className="p-8 flex flex-col gap-2 justify-center items-center">
        <div className="flex items-center justify-center gap-10">
          <div className="aspect-square w-[50px]">
            <a
              href="https://github.com/DeikuModder"
              target="_blank"
              rel="noreferrer"
            >
              <svg
          ...
          <div className="aspect-square w-[50px]">
            <a href="mailto:gabrieltc555@gmail.com">
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="text-lg font-medium tracking-wide bg-black w-[100%] p-2 text-center">
        Gabriel Trujillo, {new Date().getFullYear()}
      </div>
    </footer>
  );
};
